# Autogenerated wrapper script for mlpack_jll for armv6l-linux-musleabihf-cxx11
...
JLLWrappers.@declare_library_product(libmlpack_julia_adaboost_classify, "libmlpack_julia_adaboost_classify.so")
JLLWrappers.@declare_library_product(libmlpack_julia_adaboost_probabilities, "libmlpack_julia_adaboost_probabilities.so")
JLLWrappers.@declare_library_product(libmlpack_julia_adaboost_train, "libmlpack_julia_adaboost_train.so")
JLLWrappers.@declare_library_product(libmlpack_julia_approx_kfn, "libmlpack_julia_approx_kfn.so")
JLLWrappers.@declare_library_product(libmlpack_julia_bayesian_linear_regression_predict, "libmlpack_julia_bayesian_linear_regression_predict.so")
JLLWrappers.@declare_library_product(libmlpack_julia_bayesian_linear_regression_train, "libmlpack_julia_bayesian_linear_regression_train.so")
...
JLLWrappers.@declare_library_product(libmlpack_julia_decision_tree_classify, "libmlpack_julia_decision_tree_classify.so")
JLLWrappers.@declare_library_product(libmlpack_julia_decision_tree_probabilities, "libmlpack_julia_decision_tree_probabilities.so")
JLLWrappers.@declare_library_product(libmlpack_julia_decision_tree_train, "libmlpack_julia_decision_tree_train.so")
...
JLLWrappers.@declare_library_product(libmlpack_julia_lars_predict, "libmlpack_julia_lars_predict.so")
JLLWrappers.@declare_library_product(libmlpack_julia_lars_train, "libmlpack_julia_lars_train.so")
JLLWrappers.@declare_library_product(libmlpack_julia_linear_regression_predict, "libmlpack_julia_linear_regression_predict.so")
JLLWrappers.@declare_library_product(libmlpack_julia_linear_regression_train, "libmlpack_julia_linear_regression_train.so")
...
JLLWrappers.@declare_library_product(libmlpack_julia_logistic_regression_classify, "libmlpack_julia_logistic_regression_classify.so")
JLLWrappers.@declare_library_product(libmlpack_julia_logistic_regression_probabilities, "libmlpack_julia_logistic_regression_probabilities.so")
JLLWrappers.@declare_library_product(libmlpack_julia_logistic_regression_train, "libmlpack_julia_logistic_regression_train.so")
...
JLLWrappers.@declare_library_product(libmlpack_julia_random_forest_classify, "libmlpack_julia_random_forest_classify.so")
JLLWrappers.@declare_library_product(libmlpack_julia_random_forest_probabilities, "libmlpack_julia_random_forest_probabilities.so")
JLLWrappers.@declare_library_product(libmlpack_julia_random_forest_train, "libmlpack_julia_random_forest_train.so")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        ...
        "lib/libmlpack_julia_adaboost_classify.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_adaboost_probabilities,
        "lib/libmlpack_julia_adaboost_probabilities.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_adaboost_train,
        "lib/libmlpack_julia_adaboost_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        libmlpack_julia_bayesian_linear_regression_predict,
        "lib/libmlpack_julia_bayesian_linear_regression_predict.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_bayesian_linear_regression_train,
        "lib/libmlpack_julia_bayesian_linear_regression_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        ...
        "lib/libmlpack_julia_decision_tree_classify.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_decision_tree_probabilities,
        "lib/libmlpack_julia_decision_tree_probabilities.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_decision_tree_train,
        "lib/libmlpack_julia_decision_tree_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        ...
        "lib/libmlpack_julia_lars_predict.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_lars_train,
        "lib/libmlpack_julia_lars_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_linear_regression_predict,
        "lib/libmlpack_julia_linear_regression_predict.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_linear_regression_train,
        "lib/libmlpack_julia_linear_regression_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        ...
        "lib/libmlpack_julia_logistic_regression_classify.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_logistic_regression_probabilities,
        "lib/libmlpack_julia_logistic_regression_probabilities.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_logistic_regression_train,
        "lib/libmlpack_julia_logistic_regression_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        ...
        "lib/libmlpack_julia_random_forest_classify.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_random_forest_probabilities,
        "lib/libmlpack_julia_random_forest_probabilities.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libmlpack_julia_random_forest_train,
        "lib/libmlpack_julia_random_forest_train.so",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
