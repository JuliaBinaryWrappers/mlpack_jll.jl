# Autogenerated wrapper script for mlpack_jll for x86_64-unknown-freebsd11.1-cxx03
...
const libmlpack_gmm_probability_splitpath = ["lib", "libmlpack_julia_gmm_probability.so"]
...
# This must be `const` so that we can use it with `ccall()`
const libmlpack_gmm_probability = "libmlpack_julia_gmm_probability.so"
