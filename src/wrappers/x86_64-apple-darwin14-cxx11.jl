...
const libmlpack_splitpath = ["lib", "libmlpack.3.4.dylib"]
...
const libmlpack_julia_bayesian_linear_regression_splitpath = ["lib", "libmlpack_julia_bayesian_linear_regression.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libmlpack_julia_bayesian_linear_regression = "@rpath/libmlpack_julia_bayesian_linear_regression.dylib"
...
const libmlpack_julia_kde_splitpath = ["lib", "libmlpack_julia_kde.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libmlpack_julia_kde = "@rpath/libmlpack_julia_kde.dylib"
...
const libmlpack_julia_preprocess_one_hot_encoding_splitpath = ["lib", "libmlpack_julia_preprocess_one_hot_encoding.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libmlpack_julia_preprocess_one_hot_encoding = "@rpath/libmlpack_julia_preprocess_one_hot_encoding.dylib"
