...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/26ffb091c2cb57dff5218ee2c952df830770036f/M/mlpack/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://www.mlpack.org/files/mlpack-4.8.0.tar.gz (SHA256 checksum: `0ab06e5c506c7ed5f072faa4c04477c65624e4a1ff62eee8c0d996ef850ec51c`)
...
* `LibraryProduct`: `libmlpack_julia_lars_predict`
* `LibraryProduct`: `libmlpack_julia_lars_train`
